...
class MapaComponent extends StatefulWidget {
  MapaComponent({Key key}) : super(key: key);

  @override
  _MapaComponent createState() => _MapaComponent();
}

class _MapaComponent extends State<MapaComponent> {
  ...
  void updateLocation(LocationData result) {
    setState(() {
      ...
      _markers[1] = createMarker(LatLng(_currentLocation.latitude + 0.010,
